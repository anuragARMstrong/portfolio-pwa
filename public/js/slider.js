          ...
          (n.prototype.show = function () {
            ...
            if (this.hasContent() && this.enabled) {
              ...
              t.support.transition && this.$tip.hasClass('fade')
                ? r.one('bsTransitionEnd', m).emulateTransitionEnd(n.TRANSITION_DURATION)
                : m();
            }
          }),
            ...
            if ((this.$element.trigger(s), !s.isDefaultPrevented()))
              return (
                ...
                t.support.transition && r.hasClass('fade')
                  ? r.one('bsTransitionEnd', i).emulateTransitionEnd(n.TRANSITION_DURATION)
                  : i(),
                (this.hoverState = null),
                this
              );
    ...
    !(function () {
      ...
      function r(t) {
        if (t && t.container) {
          ...
          console.log('ScrollReveal: invalid container "' + t.container + '" provided.'),
      ...
      function f(t) {
        ...
        (e =
          'top' === n.origin || 'left' === n.origin
            ...
            : n.distance),
          parseInt(n.distance) &&
            ((i.initial += ' translate' + n.axis + '(' + e + ')'), (i.target += ' translate' + n.axis + '(0)')),
            ...
            (e = N.store.elements[n]),
              ...
              x(e)
                ...
                : T(e) &&
                  ...
                  e.domEl.setAttribute('style', e.styles.inline + e.styles.transform.initial + e.styles.transition.instant),
                  b('reset', e),
                  (e.revealing = !1));
          });
      }
      ...
      (o.prototype.defaults = {
        ...
        (o.prototype.reveal = function (t, e, n, i) {
          var o, u, f, g, m, v;
          if (
            (void 0 !== e && 'number' == typeof e ? ((n = e), (e = {})) : (void 0 !== e && null !== e) || (e = {}),
            (o = r(e)),
            (u = s(t, o)),
            !u.length)
          )
          ...
          for (var y = 0; y < u.length; y++)
            (g = u[y].getAttribute('data-sr-id')),
              g
                ...
                : ((f = { id: a(), domEl: u[y], seen: !1, revealing: !1 }), f.domEl.setAttribute('data-sr-id', f.id)),
          ...
          return (
            !i &&
              N.isSupported() &&
              (p(t, e, n), N.initTimeout && window.clearTimeout(N.initTimeout), (N.initTimeout = window.setTimeout(h, 0))),
            N
          );
        }),
        ...
        ($.prototype.isNodeList = function (t) {
          ...
          return 'object' == typeof window.NodeList
            ...
            : t && 'object' == typeof t && n.test(e) && 'number' == typeof t.length && (0 === t.length || this.isNode(t[0]));
        }),
              ...
              o.hasClass('open') &&
                ((n && 'click' == n.type && /input|textarea/i.test(n.target.tagName) && t.contains(o[0], n.target)) ||
                  ...
                  n.isDefaultPrevented() ||
                    (i.attr('aria-expanded', 'false'), o.removeClass('open').trigger(t.Event('hidden.bs.dropdown', r)))));
            }));
        }
        function i(e) {
          return this.each(function () {
  ...
  juYr: function (t, e, n) {
    ...
    !(function (e, n) {
      ...
      function b(t, e, n, i) {
        ...
        return (
          n && ((u = +u || +l || 0), (o = n[1] ? u + (n[1] + 1) * n[2] : +n[2]), i && ((i.unit = c), (i.start = u), (i.end = o))),
          o
        );
      }
      function x(t) {
        ...
        for (var n, i, o = [], r = 0, s = t.length; r < s; r++)
          (i = t[r]),
            i.style &&
              ((n = i.style.display),
              e
                ? ('none' === n && ((o[r] = Ft.get(i, 'display') || null), o[r] || (i.style.display = '')),
      ...
      function O(t, e) {
        ...
        if (1 === e.nodeType) {
          if (Ft.hasData(t) && ((r = Ft.access(t)), (s = Ft.set(e, r)), (c = r.events))) {
            ...
            for (o in c) for (n = 0, i = c[o].length; n < i; n++) yt.event.add(e, o, c[o][n]);
          }
      ...
      function L(t, e, n, i) {
        ...
        var o,
          ...
          h = e[0],
          g = yt.isFunction(h);
        if (g || (d > 1 && 'string' == typeof h && !vt.checkClone && re.test(h)))
        ...
        if (d && ((o = E(e, t[0].ownerDocument, !1, t, i)), (r = o.firstChild), 1 === o.childNodes.length && (o = r), r || i)) {
          ...
          if (l)
            for (u = a[a.length - 1].ownerDocument, yt.map(a, j), f = 0; f < l; f++)
              (c = a[f]),
                Gt.test(c.type || '') &&
                  !Ft.access(c, 'globalEval') &&
                  yt.contains(u, c) &&
                  (c.src ? yt._evalUrl && yt._evalUrl(c.src) : s(c.textContent.replace(ae, ''), u));
        }
        return t;
      }
      function q(t, e, n) {
        for (var i, o = e ? yt.filter(e, t) : t, r = 0; null != (i = o[r]); r++)
          n || 1 !== i.nodeType || yt.cleanData(T(i)),
            i.parentNode && (n && yt.contains(i.ownerDocument, i) && C(T(i, 'script')), i.parentNode.removeChild(i));
        return t;
      }
      function R(t, e, n) {
        var i,
          ...
          'margin' === n && (s += yt.css(t, n + _t[r], !0, o)),
            i
              ? ('content' === n && (s -= yt.css(t, 'padding' + _t[r], !0, o)),
                'margin' !== n && (s -= yt.css(t, 'border' + _t[r] + 'Width', !0, o)))
              : ((s += yt.css(t, 'padding' + _t[r], !0, o)),
                'padding' !== n && (s += yt.css(t, 'border' + _t[r] + 'Width', !0, o)));
        return s;
      }
      function B(t, e, n) {
        var i,
        ...
        return ce.test(r)
          ...
          : ((i = s && (vt.boxSizingReliable() || r === t.style[e])),
            ...
            (r = parseFloat(r) || 0) + M(t, e, n || (s ? 'border' : 'content'), i, o) + 'px');
      }
      ...
      function _() {
        ye &&
          (!1 === st.hidden && n.requestAnimationFrame ? n.requestAnimationFrame(_) : n.setTimeout(_, yt.fx.interval),
          yt.fx.tick());
      }
      function z() {
        return (
      ...
      function X(t, e, n) {
        ...
        if ((l = !yt.isEmptyObject(e)) || !yt.isEmptyObject(p)) {
          f &&
            ...
            (u = yt.css(t, 'display')),
            'none' === u && (c ? (u = c) : (w([t], !0), (c = t.style.display || c), (u = yt.css(t, 'display')), w([t]))),
          ...
          for (i in p)
            l ||
              (m ? 'hidden' in m && (g = m.hidden) : (m = Ft.access(t, 'fxshow', { display: c })),
              r && (m.hidden = !g),
              g && w([t], !0),
              d.done(function () {
                  ...
                  (n = s[e]),
                    ...
                    s !== i &&
                      (c && i && (yt.isPlainObject(i) || (o = Array.isArray(i)))
                        ? (o ? ((o = !1), (r = n && Array.isArray(n) ? n : [])) : (r = n && yt.isPlainObject(n) ? n : {}),
                          (s[e] = yt.extend(c, r, i)))
                        : void 0 !== i && (s[e] = i));
            return s;
          }),
        yt.extend({
          ...
          isPlainObject: function (t) {
            ...
            return (
              ...
              (!(e = at(t)) || ('function' == typeof (n = ht.call(e, 'constructor') && e.constructor) && gt.call(n) === mt))
            );
          },
      ...
      var Ct = (function (t) {
          ...
          if (!i && ((e ? e.ownerDocument || e : H) !== j && A(e), (e = e || j), I)) {
            ...
            if (x.qsa && !_[t + ' '] && (!L || !L.test(t))) {
              if (1 !== h) (p = e), (d = t);
                ...
                for (
                  (a = e.getAttribute('id')) ? (a = a.replace(bt, xt)) : e.setAttribute('id', (a = F)), u = E(t), r = u.length;
                  r--;
          ...
          for (
            ...
            if ((n = w.relative[t[a].type])) u = [d(p(u), n)];
              ...
              if (((n = w.filter[t[a].type].apply(null, t[a].matches)), n[F])) {
                ...
                return m(
                  a > 1 && p(u),
                  a > 1 && f(t.slice(0, a - 1).concat({ value: ' ' === t[a - 2].type ? '*' : '' })).replace(rt, '$1'),
                  n,
                  a < i && v(t.slice(a, i)),
                  i < o && v((t = t.slice(i))),
                  i < o && f(t)
        ...
        var b,
          ...
          ft = {
            ...
            needsContext: new RegExp(
              '^' + tt + '*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\(' + tt + '*((?:-\\d)?\\d*)' + tt + '*\\)|)(?=[^-]|$)',
              'i'
            )
          },
        ...
        (x = e.support = {}),
              ...
              return i !== j && 9 === i.nodeType && i.documentElement
                ? ((j = i),
                  ...
                  H !== j &&
                    (n = j.defaultView) &&
                    n.top !== n &&
                    (n.addEventListener ? n.addEventListener('unload', wt, !1) : n.attachEvent && n.attachEvent('onunload', wt)),
                  ...
                  (x.qsa = ht.test(j.querySelectorAll)) &&
                    (o(function (t) {
                      (O.appendChild(t).innerHTML =
                        ...
                        t.querySelectorAll('[selected]').length || L.push('\\[' + tt + '*(?:value|' + K + ')'),
          ...
          (e.matchesSelector = function (t, n) {
            if (
              ...
              (n = n.replace(lt, "='$1']")),
              x.matchesSelector && I && !_[n + ' '] && (!q || !q.test(n)) && (!L || !L.test(n)))
            )
              try {
                var i = R.call(t, n);
                          ...
                          if (((h = [s ? m.firstChild : m.lastChild]), s && y)) {
                            ...
                            for (
                              ...
                              ((a ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) ||
                                !++b ||
                                (y && ((f = d[F] || (d[F] = {})), (u = f[d.uniqueID] || (f[d.uniqueID] = {})), (u[t] = [W, b])),
                                d !== e));
        ...
        return (
            ...
            function (t, n) {
              ...
              for (a = t, l = [], c = w.preFilter; a; ) {
                (i && !(o = st.exec(a))) || (o && (a = a.slice(o[0].length) || a), l.push((r = []))),
                  (i = !1),
                  (o = at.exec(a)) &&
                    ((i = o.shift()), r.push({ value: i, type: o[0].replace(rt, ' ') }), (a = a.slice(i.length)));
                for (s in w.filter)
                  !(o = ft[s].exec(a)) ||
                    (c[s] && !(o = c[s](o))) ||
          ...
          (x.attributes &&
            o(function (t) {
              return (
                (t.innerHTML = '<input/>'), t.firstChild.setAttribute('value', ''), '' === t.firstChild.getAttribute('value')
              );
            })) ||
          ...
          function (t, e) {
            yt.fn[t] = function (n, i) {
              ...
              return (
                ...
                this.length > 1 && (Ot[t] || yt.uniqueSort(o), jt.test(t) && o.reverse()),
                this.pushStack(o)
              );
            };
          }
            ...
            var e = [
              ...
              o = {
                ...
                then: function (t, i, o) {
                            ...
                            (c = n && ('object' == typeof n || 'function' == typeof n) && n.then),
                              yt.isFunction(c)
                                ? o
                                  ...
                                  : (s++, c.call(n, r(s, e, d, o), r(s, e, p, o), r(s, e, d, e.notifyWith)))
                                : (i !== d && ((a = void 0), (l = [n])), (o || e.resolveWith)(a, l));
                          }
                        },
                        u = o
                          ? c
                          : function () {
                              try {
                                ...
                                yt.Deferred.exceptionHook && yt.Deferred.exceptionHook(n, u.stackTrace),
                                  t + 1 >= s && (i !== p && ((a = void 0), (l = [n])), e.rejectWith(a, l));
                              }
                            };
                  ...
                  return yt
                    .Deferred(function (n) {
                      e[0][3].add(r(0, n, yt.isFunction(o) ? o : d, n.notifyWith)),
        ...
        yt.extend({
          ...
          ready: function (t) {
            (!0 === t ? --yt.readyWait : yt.isReady) ||
              ((yt.isReady = !0), (!0 !== t && --yt.readyWait > 0) || qt.resolveWith(st, [yt]));
          }
        }),
      ...
      (m.uid = 1),
        (m.prototype = {
          ...
          remove: function (t, e) {
            ...
            if (void 0 !== i) {
              if (void 0 !== e) {
                Array.isArray(e) ? (e = e.map(yt.camelCase)) : ((e = yt.camelCase(e)), (e = e in i ? [e] : e.match(It) || [])),
                  (n = e.length);
                for (; n--; ) delete i[e[n]];
              }
          ...
          queue: function (t, e, n) {
            ...
            if (t)
              return (
                (e = (e || 'fx') + 'queue'),
                (i = Ft.get(t, e)),
                n && (!i || Array.isArray(n) ? (i = Ft.access(t, e, yt.makeArray(n))) : i.push(n)),
                i || []
              );
          },
        ...
        yt.fn.extend({
          ...
          promise: function (t, e) {
            ...
            for ('string' != typeof t && ((e = t), (t = void 0)), t = t || 'fx'; s--; )
              (n = Ft.get(r[s], t + 'queueHooks')) && n.empty && (i++, n.empty.add(a));
        ...
        zt = function (t, e) {
          return (
            ...
            'none' === t.style.display ||
              ('' === t.style.display && yt.contains(t.ownerDocument, t) && 'none' === yt.css(t, 'display'))
          );
        },
        Vt = function (t, e, n, i) {
          var o,
                ...
                for (
                  ...
                  (u = d[r]),
                    (!o && g !== u.origType) ||
                      ...
                      (d.splice(r, 1), u.selector && d.delegateCount--, f.remove && f.remove.call(t, u));
                s &&
                  !d.length &&
                  ((f.teardown && !1 !== f.teardown.call(t, h, m.handle)) || yt.removeEvent(t, p, m.handle), delete l[p]);
            ...
            for (s = yt.event.handlers.call(this, a, c), e = 0; (o = s[e++]) && !a.isPropagationStopped(); )
              for (a.currentTarget = o.elem, n = 0; (r = o.handlers[n++]) && !a.isImmediatePropagationStopped(); )
                (a.rnamespace && !a.rnamespace.test(r.namespace)) ||
                  ((a.handleObj = r),
                  (a.data = r.data),
                  void 0 !== (i = ((yt.event.special[r.origType] || {}).handle || r.handler).apply(o.elem, l)) &&
                    !1 === (a.result = i) &&
            ...
            for (; c !== this; c = c.parentNode || this)
              if (1 === c.nodeType && ('click' !== t.type || !0 !== c.disabled)) {
                for (r = [], s = {}, n = 0; n < l; n++)
                  (i = e[n]),
                    (o = i.selector + ' '),
                    void 0 === s[o] && (s[o] = i.needsContext ? yt(o, this).index(c) > -1 : yt.find(o, this, null, [c]).length),
                    s[o] && r.push(i);
        ...
        style: function (t, e, n, i) {
          if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
            var o,
              ...
              l = de.test(e),
              c = t.style;
            if ((l || (e = H(a)), (s = yt.cssHooks[e] || yt.cssHooks[a]), void 0 === n))
              return s && 'get' in s && void 0 !== (o = s.get(t, !1, i)) ? o : c[e];
            (r = typeof n),
              'string' === r && (o = Ut.exec(n)) && o[1] && ((n = b(t, e, o)), (r = 'number')),
              null != n &&
                n === n &&
                ('number' === r && (n += (o && o[3]) || (yt.cssNumber[a] ? '' : 'px')),
                vt.clearCloneStyle || '' !== n || 0 !== e.indexOf('background') || (c[e] = 'inherit'),
          ...
          run: function (t) {
            ...
            return (
              this.options.duration
                ? (this.pos = e = yt.easing[this.easing](t, this.options.duration * t, 0, 1, this.options.duration))
                : (this.pos = e = t),
        ...
        (U.propHooks = {
          _default: {
            ...
            set: function (t) {
              yt.fx.step[t.prop]
                ? yt.fx.step[t.prop](t)
                : 1 !== t.elem.nodeType || (null == t.elem.style[yt.cssProps[t.prop]] && !yt.cssHooks[t.prop])
                ? (t.elem[t.prop] = t.now)
          ...
          return (
            yt.fx.off
              ...
              : 'number' != typeof i.duration &&
                (i.duration in yt.fx.speeds ? (i.duration = yt.fx.speeds[i.duration]) : (i.duration = yt.fx.speeds._default)),
          ...
          attr: function (t, e, n) {
            ...
            if (3 !== r && 8 !== r && 2 !== r)
              return void 0 === t.getAttribute
                ? yt.prop(t, e, n)
                : ((1 === r && yt.isXMLDoc(t)) ||
                    (o = yt.attrHooks[e.toLowerCase()] || (yt.expr.match.bool.test(e) ? we : void 0)),
                  void 0 !== n
                    ? null === n
        ...
        yt.fn.extend({
          ...
          hasClass: function (t) {
            var e,
              n,
              i = 0;
            for (e = ' ' + t + ' '; (n = this[i++]); ) if (1 === n.nodeType && (' ' + J(Z(n)) + ' ').indexOf(e) > -1) return !0;
            return !1;
          }
        });
      var ke = /\r/g;
      yt.fn.extend({
        val: function (t) {
            ...
            o = this[0];
          {
              ...
              return (
                ...
                this.each(function (n) {
                  ...
                  1 === this.nodeType &&
                    ...
                    ((e = yt.valHooks[this.type] || yt.valHooks[this.nodeName.toLowerCase()]) &&
                      'set' in e &&
            ...
            if (o)
              return (e = yt.valHooks[o.type] || yt.valHooks[o.nodeName.toLowerCase()]) &&
                'get' in e &&
                void 0 !== (n = e.get(o, 'value'))
                ? n
                : ((n = o.value), 'string' == typeof n ? n.replace(ke, '') : null == n ? '' : n);
          }
        }
      }),
        yt.extend({
          ...
          if (
            ...
            for (r = 0; (s = d[r++]) && !t.isPropagationStopped(); )
              (t.type = r > 1 ? l : f.bindType || p),
                (u = (Ft.get(s, 'events') || {})[t.type] && Ft.get(s, 'handle')),
                u && u.apply(s, e),
                (u = c && s[c]) && u.apply && Pt(s) && ((t.result = u.apply(s, e)), !1 === t.result && t.preventDefault());
            return (
              (t.type = p),
              o ||
          ...
          serializeArray: function () {
            return this.map(function () {
              ...
              .filter(function () {
                var t = this.type;
                return (
                  this.name && !yt(this).is(':disabled') && Ie.test(this.nodeName) && !Oe.test(t) && (this.checked || !Xt.test(t))
                );
              })
              .map(function (t, e) {
                var n = yt(this).val();
      ...
      (_e.href = $e.href),
        yt.extend({
          ...
          ajax: function (t, e) {
            ...
            if (
              (h.data && h.processData && 'string' != typeof h.data && (h.data = yt.param(h.data, h.traditional)),
              et(Me, h, e, C),
              u)
            )
              return C;
            (f = yt.event && h.global),
              ...
              h.hasContent
                ...
                : ((p = h.url.slice(r.length)),
                  h.data && ((r += (De.test(r) ? '&' : '?') + h.data), delete h.data),
                  !1 === h.cache && ((r = r.replace(Re, '$1')), (p = (De.test(r) ? '&' : '?') + '_=' + Ne++ + p)),
                  (h.url = r + p)),
              h.ifModified &&
                (yt.lastModified[r] && C.setRequestHeader('If-Modified-Since', yt.lastModified[r]),
              ...
              C.setRequestHeader(
                ...
                h.dataTypes[0] && h.accepts[h.dataTypes[0]]
                  ? h.accepts[h.dataTypes[0]] + ('*' !== h.dataTypes[0] ? ', ' + Ue + '; q=0.01' : '')
                  : h.accepts['*']
              );
        ...
        yt.each(['get', 'post'], function (t, e) {
          yt[e] = function (t, n, i, o) {
            return (
              ...
              yt.ajax(yt.extend({ url: t, type: e, dataType: o, data: n, success: i }, yt.isPlainObject(t) && t))
            );
          };
        }),
          ...
          if (a || 'jsonp' === t.dataTypes[0])
            return (
              ...
              a
                ...
                : !1 !== t.jsonp && (t.url += (De.test(t.url) ? '&' : '?') + t.jsonp + '=' + o),
        ...
        (yt.offset = {
          setOffset: function (t, e, n) {
            ...
            'static' === u && (t.style.position = 'relative'),
              ...
              c ? ((i = f.position()), (s = i.top), (o = i.left)) : ((s = parseFloat(r) || 0), (o = parseFloat(l) || 0)),
            ...
            if (r)
              return r.getClientRects().length
                ? ((i = r.getBoundingClientRect()),
                  ...
                  (n = e.documentElement),
                  (o = e.defaultView),
                  { top: i.top + o.pageYOffset - n.clientTop, left: i.left + o.pageXOffset - n.clientLeft })
                : { top: 0, left: 0 };
          },
          position: function () {
            if (this[0]) {
              ...
              return Rt(
                ...
                function (e, n, o) {
                  ...
                  return yt.isWindow(e)
                    ...
                    : 9 === e.nodeType
                    ? ((r = e.documentElement),
                      Math.max(e.body['scroll' + t], r['scroll' + t], e.body['offset' + t], r['offset' + t], r['client' + t]))
                    : void 0 === o
                    ? yt.css(e, n, a)
                    : yt.style(e, n, o, a);
                },
              ...
              setTimeout(
                t.proxy(function () {
                  i[o](null == r[e] ? this.options[e] : r[e]),
                    'loadingText' == e
                      ? ((this.isLoading = !0), i.addClass(n).attr(n, n).prop(n, !0))
                      : this.isLoading && ((this.isLoading = !1), i.removeClass(n).removeAttr(n).prop(n, !1));
                }, this),
                0
              );
          }),
            ...
            e && e.preventDefault(),
              ...
              e.isDefaultPrevented() ||
                ...
                t.support.transition && s.hasClass('fade')
                  ? s.one('bsTransitionEnd', n).emulateTransitionEnd(i.TRANSITION_DURATION)
                  : n());
          });
        var o = t.fn.alert;
        (t.fn.alert = e),
                ...
                t.support.transition && this.$element.hasClass('slide')
                  ? (r.addClass(e),
                    ...
                    o
                      ...
                      .emulateTransitionEnd(n.TRANSITION_DURATION))
                  : (o.removeClass('active'), r.addClass('active'), (this.sliding = !1), this.$element.trigger(d)),
                s && this.cycle(),
                this
              );
            }
